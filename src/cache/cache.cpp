...
struct Cache::Impl {
    ...
    virtual std::optional<std::int64_t> incr(const std::string& key) = 0;
    virtual std::optional<std::int64_t> decr(const std::string& key) = 0;
    ...
    virtual std::optional<std::string> set_join(const std::string& dest, const std::string& list,
    ...
    virtual std::optional<Cache::clock::time_point> expiretime(const std::string& key) = 0;
...
public:
    ...
    std::optional<std::string>  get (const std::string& key) override { return kv_.get(key); }
    std::optional<std::int64_t> incr(const std::string& key) override { return kv_.incr(key); }
    std::optional<std::int64_t> decr(const std::string& key) override { return kv_.decr(key); }
    ...
    std::optional<std::string> lpop(const std::string& key) override { return kv_.lpop(key); }
    std::optional<std::string> rpop(const std::string& key) override { return kv_.rpop(key); }
    ...
    std::optional<std::string> set_join(const std::string& dest, const std::string& list,
                                             const std::string& prefix, const std::string& sep,
    ...
    std::optional<Cache::clock::time_point> expiretime(const std::string& key) override {
...
std::optional<std::string>  Cache::get (const std::string& key) { return impl_->get(key); }
std::optional<std::int64_t> Cache::incr(const std::string& key) { return impl_->incr(key); }
std::optional<std::int64_t> Cache::decr(const std::string& key) { return impl_->decr(key); }
...
std::optional<std::string> Cache::lpop(const std::string& key) { return impl_->lpop(key); }
std::optional<std::string> Cache::rpop(const std::string& key) { return impl_->rpop(key); }
...
std::optional<std::string> Cache::set_join(const std::string& dest,
...
std::optional<Cache::clock::time_point>
